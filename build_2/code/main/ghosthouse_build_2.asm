...
frame.addr.bank:
  .db bank(ghost_0.cell),bank(ghost_0.cell),bank(ghost_0.cell),bank(ghost_0.cell)
frame.addr.lo:
  .db low(ghost_0.cell),low(ghost_0.cell+$500),low(ghost_0.cell+$a00),low(ghost_0.cell+$f00)
frame.addr.hi:
  .db high(ghost_0.cell),high(ghost_0.cell+$500),high(ghost_0.cell+$a00),high(ghost_0.cell+$f00)
